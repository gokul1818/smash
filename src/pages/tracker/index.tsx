        ...
        <div className='d-flex flex-row justify-content-center  align-items-center mt-5'>
          <div className={`podium-container`}>
            ...
            <div className='rank1-profile-img'>
              <img src={sortedUserDetails[0]?.profilePic || dummyImg} className='rank-profile-img' alt='rank1' />
              <p className='  mb-3  white-color ubuntu-regular fs-18 text-center '>
                {sortedUserDetails[0]?.name}
              </p>
            </div>
            <div className='rank2-profile-img'>
              <img src={sortedUserDetails[1]?.profilePic || dummyImg} className='rank-profile-img' alt='rank2' />
              <p className='  mb-3  white-color ubuntu-regular fs-18 text-center '>
                {sortedUserDetails[1]?.name}
              </p>
            </div>
            <div className='rank3-profile-img'>
              <img src={sortedUserDetails[2]?.profilePic || dummyImg} className='rank-profile-img' alt='rank3' />
              <p className=' mb-3  white-color ubuntu-regular fs-18 text-center '>
          ...
          <div key={index}>
            <div className={`top-palyer-list-card  ${index == 0 ? "rank1card" : index == 1 ? "rank2card" : index == 2 ? "rank3card" : ""}`}>
              <div className='w-50  d-flex align-items-center'>
                <img src={players.profilePic || dummyImg} className='top-palyer-list-profile-img' alt={`rank ${index + 1}`} />
